...
/* يخفي تلميح Streamlit التلقائي بالإنجليزي ("Press Enter to apply") تحتimport os, re, streamlit as st
...
الإجابة المختصرة:"""
    ...
    st.markdown(f"<div class='disclaimer-box' dir='rtl'>{TANWIH}</div>", unsafe_allow_html=True) خانة الكتابة */
div[data-testid="InputInstructions"] { display:none !important; }
</style>
""", unsafe_allow_html=True)
